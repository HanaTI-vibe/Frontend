  ...
  const startGame = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // 시스템 메시지는 WebSocket을 통해 모든 참가자에게 전달되므로 여기서는 추가하지 않음
      } else {
        ...
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            <div className="flex items-center justify-center gap-2">
              ...
              <CardTitle>L2Q</CardTitle>
            </div>
            <CardDescription>이름을 입력하고 퀴즈에 참여하세요</CardDescription>
          </CardHeader>
                        ...
                        <div
                          ...
                          className={`flex items-center justify-between p-2 rounded transition-all duration-300 ${
                            participant.id === currentUser
                              ...
                              : gameStarted &&
                                submittedParticipants.has(participant.id)
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-2 sm:p-4">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 gap-3">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
              ...
              >
                ...
                {unreadCount > 0 && (
                  <Badge className="absolute -top-2 -right-2 h-4 w-4 sm:h-5 sm:w-5 p-0 text-xs">
                    {unreadCount}
                  </Badge>
                )}
              </Button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-3 sm:gap-6">
          ...
          <div
            className={`order-1 ${
              isChatVisible ? "lg:col-span-2" : "lg:col-span-3"
            }`}
          >
            <Card>
              <CardHeader>
          ...
          {/* 사이드바 - 참가자 및 점수 */}
          <div className="order-3 lg:order-2 space-y-3 sm:space-y-4">
            {/* 초대코드 표시 카드 */}
            <Card>
              <CardHeader>
      ...
      <Dialog open={showFinalScoreModal}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-hidden flex flex-col w-[95vw] sm:w-full">
          <DialogHeader className="flex-shrink-0">
            <DialogTitle className="text-center text-xl sm:text-2xl font-bold text-green-600 flex items-center justify-center gap-2">
          ...
          <div className="flex-1 overflow-y-auto space-y-4 sm:space-y-6 pr-2">
            ...
            <div className="grid sm:grid-cols-2 gap-3 sm:gap-4">
              {/* 내 점수 */}
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 sm:p-6 rounded-lg border-2 border-blue-300">
                <div className="text-center">
                  <h3 className="text-base sm:text-lg font-semibold text-blue-700 mb-2 flex items-center justify-center gap-2">
                    <Star className="w-4 h-4 sm:w-5 sm:h-5" />내 최종 점수
                  </h3>
                  ...
                  {(() => {
                    // finalRanking이 없으면 participants를 사용하여 순위 계산
                    const rankingData =
                    ...
                    const myRank = rankingData.findIndex(
                      (p) => p.id === currentUser
                    );

                    return (
                      myRank >= 0 && (
                        <div className="mt-2 text-base sm:text-lg font-semibold text-blue-700">
                          {myRank + 1}등
                        </div>
                      )
                    );
              ...
              {/* 우승자 점수 */}
              {finalRanking.length > 0 && (
                <div className="bg-gradient-to-r from-yellow-50 to-amber-50 p-4 sm:p-6 rounded-lg border-2 border-yellow-300">
                  <div className="text-center">
                    <h3 className="text-base sm:text-lg font-semibold text-yellow-700 mb-2 flex items-center justify-center gap-2">
                  ...
                  const rankingData =
                    finalRanking.length > 0
                      ...
                      : participants
                          ...
                          .sort(
                            (a: any, b: any) => b.displayScore - a.displayScore
                          );

                  return rankingData.slice(0, 3).map((participant, index) => {
                      ...
                      <div
                        ...
                        className={`flex items-center justify-between p-3 sm:p-4 rounded-lg border-2 transition-all duration-200 ${
                          isCurrentUser && isWinner
                            ...
                            : index === 1
                            ? "bg-gradient-to-r from-gray-100 to-gray-50 border-gray-300 shadow-sm"
                            : "bg-gradient-to-r from-amber-100 to-amber-50 border-amber-300 shadow-sm"
                        }`}
                      >
                        <div className="flex items-center gap-2 sm:gap-3">
                          <div
                            className={`flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-full font-bold text-lg sm:text-2xl shadow-lg ${
                              isWinner
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            >
                              {participant.name}
                              {isCurrentUser && (
                                <span className="ml-1 sm:ml-2 text-blue-600 font-bold">
                                  (나)
                                </span>
                              )}
                            </div>
            ...
            {(() => {
              ...
              const myRank = rankingData.findIndex((p) => p.id === currentUser);

              if (myRank >= 3) {
                const myData = rankingData[myRank];
                return (
                  <div>
                    <h3 className="text-base sm:text-lg font-semibold text-gray-700 mb-3 sm:mb-4 text-center">
                      📊 내 순위
                    </h3>
                    <div className="bg-gradient-to-r from-blue-100 to-blue-50 p-4 sm:p-6 rounded-lg border-2 border-blue-400 ring-2 ring-blue-400 shadow-md">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <div className="flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-full font-bold text-lg sm:text-xl bg-blue-600 text-white shadow-md">
                            #{myRank + 1}
                          </div>
                          <div>
                            <div className="font-bold text-base sm:text-lg text-blue-800">
                              {myData.name} (나)
                            </div>
            ...
            <div className="bg-gray-50 p-3 sm:p-4 rounded-lg">
              <h4 className="font-semibold text-gray-700 mb-2 sm:mb-3 text-center text-sm sm:text-base">
                📊 내 상세 결과
              </h4>
